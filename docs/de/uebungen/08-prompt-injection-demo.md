...
Prompt Injection ist ein Architekturproblem: Nicht vertrauenswürdige Inhalte können das Modellverhalten beeinflussen. Die Projektverantwortlichen muss deshalb minimale Rechte, getrennte Werkzeuge, Freigaben und wiederholbare Sicherheitstests als Lieferumfang planen.
