...
Ein Risikoregister ist ein Steuerungsinstrument, wenn es konkrete Owner, Indikatoren und Reaktionen enthält. Die Projektverantwortlichen nutzt den Score zur Priorisierung, behält aber harte Sicherheits- und Datenschutzgrenzen als nicht verhandelbare Freigabekriterien bei.
